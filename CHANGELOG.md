...
- Services: `intentional.fire` (manual user intent), `intentional.reload` (hot reload)
- Sensor entities: per-target resolution state + engine summary
- Hot reload of rules via directory watcher
- Example rule files in `examples/`
- Full test suite: 156 tests across 7 test modules
- GitHub Actions CI for Python 3.11, 3.12, 3.13 with ruff, mypy, and coverage
