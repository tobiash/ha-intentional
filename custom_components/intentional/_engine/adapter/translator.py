"""Service-call translation: resolved intent set -> HA service calls.

The translator turns a resolved intent value dict into the concrete
(domain, service, data) tuples Home Assistant expects. Per ADR-0002 this
is the largest sibling in the adapter package; the domain ladders are
...
from ..registry import ALARM_STATE_SERVICES, LIGHT_COLOR_FIELDS
from . import SceneActivationPlan, ServiceCall
